        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [                    
                    ...
                    InlineKeyboardButton("• Cʜᴀᴛᴢᴏɴᴇ", url=f"https://t.me/RONNY_KI_DUNIYA"),
                    InlineKeyboardButton(" Cʜᴀᴛᴢᴏɴᴇ •", url=f"https://t.me/seqime")
               ],[
                    InlineKeyboardButton("📨 Sᴜᴘᴘᴏʀᴛ", url=f"https://t.me/RONNY_KI_DUNIYA"),
                    InlineKeyboardButton(" Uᴘᴅᴀᴛᴇs 📨", url=f"https://t.me/do_dil_ek_jaan143")
                ],[
